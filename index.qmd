...
- Different formats
    - [msword.ipynb](https:/quarto_demo/msword.ipynb)
    - [presentation.ipynb](./quarto_demo/presentation.ipynb)
    - [pdf.ipynb](./quarto_demo/pdf.ipynb)
- Some of my favorite features
    - [annotation.qmd](./quarto_demo/annotation.qmd)
